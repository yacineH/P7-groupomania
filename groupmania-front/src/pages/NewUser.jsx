    ...
    return (<div>
              ...
              <div className="container">
                  ...
                  <div  className="row">
                     ...
                     <form style={{border : "1px solid #ffd7d7",height:"350px"}} 
                           className="col-8 m-0" onSubmit={handleSubmit}>                   
                        <div className="form-group row mt-4">
                           <label htmlFor="name" className="col-4 col-form-label">Nom</label>
                           <input type="text" name="name"  className="form-control col-7" 
                                 id="name" aria-describedby="nomHelp" onChange={handleChange}/>
                        </div> 
                        <div className="form-group row mt-4">
                           <label htmlFor="email"  className="col-4 col-form-label">Email</label>
                           <input type="email" name="email" placeholder="name@example.com" className="form-control col-7" 
                        ...
                        <div className="form-group row mt-4">
                           ...
                           <input type="password" className="form-control col-7" id="password"
                                 name="password" onChange={handleChange}/>
                        </div>

                        <div style={{  marginTop: "35px",
                                       textAlign:"end" ,marginRight:"25px"}}>              
